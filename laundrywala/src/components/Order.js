...
const CartTable = styled.table`
  ...
  .clear-all,
  .qty-button {
    background: linear-gradient(45deg, #d9534f, #b52a25);
    border: none;
    color: white;
    padding: 5px 10px;
    border-radius: 5px;
    ...
    &:hover {
      background: linear-gradient(45deg, #b52a25, #d9534f);
    }
  }
...
const Order = () => {
  ...
  return (
    <Section>
      <Container>
        <Row className="justify-content-between py-3 mt-5 confirm-order">
          <Col md={12}>
        ...
        <Row>
          <Col md={7}>
            <SubTitle>Edit Pickup & Delivery Details</SubTitle>
            <hr />
            <div className="address-details px-2 mb-3">
              <StyledForm className="py-2" onSubmit={submitHandler}>
                <div className="px-2 mb-3">
                  <h5>Schedule</h5>
                  <span className="from-text">
                    Expert will arrive at your given address within 30 minutes
                ...
                <div className="mt-4 mb-3">
                  <h5>Payment Method</h5>
                  <span className="from-text">
                    Expert will collect your payment after delivering your order
                  </span>
                </div>
                <FormGroup check className="form-check-radio" inline>
                  <Label check>
                  ...
                  <FormGroup check className="form-check-radio" inline></FormGroup>
                  <Label check>
                    <Input
                      id="inlineRadio1"
                      name="payment"
          ...
          <Col md={7} className="mb-5">
            <CartTable>
              ...
              <tbody>
                {isEmpty ? (
                  ...
                  items.map((item) => (
                    <tr key={item.id}>
                      ...
                      <td>৳ {item.itemTotal}</td>
                      <td>
                        <button onClick={() => removeItem(item.id)} className="clear-one">
                          X
                        </button>
                      </td>
                    </tr>
                ...
                <tr>
                  <td colSpan={5}>
                    <span className="nb">(Free delivery cost for orders up to ৳1000)</span>
                  </td>
                </tr>
              </tbody>
            </CartTable>
